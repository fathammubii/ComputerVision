...
def detection():
    ...
    global img1, iago, img2, iago2, blmaskRez, iago3, hsv
    ...
    black_low = np.array([129, 0, 0], np.uint8)
    black_high = np.array([155, 255, 50], np.uint8)
...
def gui():
    ...
    win.title("Deteksi Penyakit Busuk Daun Selada dengan Ruang Warna HSV")
    ...
    judulruang = Label(frame_1,text = 'Ruang Warna HSV', font=("arial",21),bg='#929292').place(x= 856,y = 26, width=300)
...
if __name__ == '__main__':
    ...
    del img1, iago, img2, iago2, blmaskRez, iago3, hsv